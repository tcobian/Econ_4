...
deno2 = slope_a * slope_line_b + slope_a * slope_line_c + slope_line_b * slope_line_c + slope_a * slope_line_d + slope_line_d*slope_line_b + slope_line_d*slope_line_c

agg_y_int2 = (int_a*slope_line_b*slope_line_c*slope_line_d/deno) + (int_line_b*slope_a*slope_line_c*slope_line_d/deno) + (int_line_c*slope_line_b*slope_a*slope_line_d/deno)

agg_coeff2 = (slope_a*slope_line_b*slope_line_c*slope_line_d/deno)

agg_abate_reverse2 <- function(x){
  agg_coeff2*x + agg_y_int2
}
price2 <- agg_abate_reverse2(300) #10.24805 
