...
```
- local air pollution for counrty x: `r round(x_pollute_2, 2)`
- local air pollustion for country y: `r round(y_pollute_2, 2)`
...
- If international trade is allowed then you will be able to gain more benefit from the reduction of carbon emissions but this will have a negative effect on local air pollution. This is because there are local air pollutants that will affect the local community. International trade of carbon will not adress this issue as the pollutants remain local.
